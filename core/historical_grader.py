...
from . import assists, moneyline, nrfi, rebounds, run_line, strikeouts, totals
    ...
    try:
        if sport == "MLB":
            ...
            if market == "pitcher_strikeouts":
                ...
                side = (pick.get("side") or "home").strip().lower()
                return mlb.get_run_line_margin(game_pk, side), None
            else:
