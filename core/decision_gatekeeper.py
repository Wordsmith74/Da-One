...
_MARKET_ENTRY_FLOORS: dict[str, tuple[float, float]] = {
    "pitcher_strikeouts": (3.0, 70.0),   # MLB Ks — entry floor (2026-07-07: raised from
                                          # 2.0/68.0 per updated spec). This is the pre-tier
                                          # gate only; _MARKET_TIER_THRESHOLDS above still
                                          # applies the 3.72% Nuke/Diamond/Gold cuts on top of
                                          # whatever clears this floor.
