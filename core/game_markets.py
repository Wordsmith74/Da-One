...
Scans ALL approved markets for each game before any NO-PLAY decision:
  ...
  MLB  : First-5 Total, First-5 ML, First-5 Run Line, NRFI, YRFI,
         Team Totals (home + away), Full Game ML, Full Game Run Line
...
#   MLB  — F5 total / F5 moneyline / F5 run line / full-game run line
#   WNBA — full-game moneyline only (spreads and team-totals removed)
#   NBA  — no markets in scope (empty string → fetch_expanded_game_candidates returns [])
_MARKET_BUNDLE: dict[str, str] = {
    "MLB":  "totals_first_5_innings,h2h_first_5_innings,spreads_first_5_innings,totals_1st_1_innings,spreads",
