...
Allowed scope
─────────────
MLB:  Game Total · Run Line · F5 total · F5 moneyline · F5 run line · NRFI · YRFI · Pitcher Ks
WNBA: Game Total · Player Assists · Player Rebounds · Moneyline
...
ALLOWED_MARKETS: dict[str, frozenset[str]] = {
    "MLB": frozenset({
        ...
        "first_5_total",        # F5 over/under total  (Bayesian)
        "first_5_ml",           # F5 moneyline         (precomputed)
        "first_5_rl",           # F5 run line          (precomputed)
        "nrfi",                 # No Run First Inning  (core/game_markets.py._process_nrfi_yrfi)
        "yrfi",                 # Yes Run First Inning (core/game_markets.py._process_nrfi_yrfi)
        "pitcher_strikeouts",   # Pitcher K prop       (Bayesian)
