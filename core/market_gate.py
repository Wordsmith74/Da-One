...
Allowed scope
─────────────
MLB:  Moneyline · Run Line (Spread) · Game Total  -- scope narrowed on request;
      F5 total/ML/RL, NRFI/YRFI, and Pitcher Ks are intentionally OUT of scope.
...
ALLOWED_MARKETS: dict[str, frozenset[str]] = {
    # MLB scope narrowed to moneyline / run line (spread) / game total only.
    # F5 total/ML/RL, NRFI/YRFI, and pitcher_strikeouts are deliberately
    # excluded -- any candidate for those markets is blocked here exactly
    # like an out-of-scope NBA candidate would be.
    "MLB": frozenset({
