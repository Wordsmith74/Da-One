...
#   MLB  — F5 total / F5 moneyline / F5 run line only (full-game removed)
...
_MARKET_BUNDLE: dict[str, str] = {
    "MLB":  "totals_first_5_innings,h2h_first_5_innings,spreads_first_5_innings,totals_1st_1_innings",
