...
_MARKET_ENTRY_FLOORS: dict[str, tuple[float, float]] = {
    ...
    "run_line":           (0.0, 68.0),   # Full-game run line (MLB + WNBA; game_markets.py
                                          # labels all spreads "run_line") — no graded history yet,
                                          # revisit this floor once picks have graded outcomes.
}
